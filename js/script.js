...
// Função para gerar a tabela agrupada por semana (com mesclagem na primeira coluna)
function gerarTabela(event) {
    ...
    for (let d = 0; d < 7; d++) {
      ...
      if (diasSelecionados.includes(currentDate.getDay())) {
        ...
        const diffDays = Math.floor(
          (currentDate - dataInicio) / (1000 * 60 * 60 * 24)
        );
  ...
  // Ordena as semanas (caso não estejam em ordem)
